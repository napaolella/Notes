...
arey
same type
array var stores refrence to arey
int[] values;
Dice[] dice;
values = new int[10];
int[] values = new int[10];
ints default to 0
int[] values = {2,13,66,23,456,2}
size no change
arrey.length

mega thicc for lewp
acesses values in arrey
...
linear search = search till u find what u loking for

2 dimension arrey = tabel
row then colum
array of arrays
int[][] values = new int [rows][colums];
int [][] stuff = {{1,2,3},{2,3,4}};
data.length = number of rows
data[0].length = num of colums

arrey list = class, no primitives
Integer.parseInt("22")
